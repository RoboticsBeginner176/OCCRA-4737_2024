...
import static occra.Robot.Constants.LauncherConstants.kLeftLauncherSpeed;
import static occra.Robot.Constants.LauncherConstants.kReverseLeftLauncherSpeed;
import static occra.Robot.Constants.LauncherConstants.kRightLauncherSpeed;
import static occra.Robot.Constants.LauncherConstants.kReverseRightLauncherSpeed;
...
public class CANLauncher extends SubsystemBase {
  ...
  public CANLauncher() {
    m_leftLaunchWheel = new CANSparkMax(6, MotorType.kBrushless);
    m_rightLaunchWheel = new CANSparkMax(5, MotorType.kBrushless);

    m_leftLaunchWheel.setSmartCurrentLimit(100);
    m_rightLaunchWheel.setSmartCurrentLimit(100);
  ...
  public Command getLauncherCommand() {
   ...
   public Command getShooterIntakeCommand() {
    ...
    return this.startEnd(
        // When the command is initialized, set the wheels to the intake speed values
        () -> {
          setLeftLaunchWheel(3);
          setRightLaunchWheel(0.6);
        },
        // When the command stops, stop the wheels
        () -> {
          stop();
