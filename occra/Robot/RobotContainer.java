...
//import frc.robot.Constants.LauncherConstants;
import occra.Robot.Constants.OperatorConstants;
import occra.Robot.Command.Autos;
//import frc.robot.commands.ElevatorUp;
//import frc.robot.commands.LaunchNote;
//import frc.robot.commands.PrepareLaunch;
//import frc.robot.commands.IntakeNote;
//import frc.robot.commands.IntakeLauncher;
import occra.Robot.Command.FeedShoot;
import occra.Robot.Subsystem.CANClimber;
...
// Rodent Turtle Tina waz hear
  ...
  private void configureBindings() {
   ...
   // m_operatorController
    ...
    // left trigger
    m_driverController.leftTrigger().whileTrue(m_launcher.getAmpShooterCommand());

    m_operatorController.rightTrigger().whileTrue(m_launcher.getLauncherCommand());
    m_operatorController.b().whileTrue(m_Climber.getClimberDownCommand());
    m_operatorController.y().whileTrue(m_Climber.getClimberUpCommand());
    //m_operatorController.y().whileTrue(m_launcher.getAmpShooterCommand());
    // Set up a binding to run the intake command while the operator is pressing and holding the
    // right trigger
    m_operatorController.leftTrigger().whileTrue(m_Intake.getIntakeNoteCommand());
    m_operatorController.leftTrigger().whileTrue(m_launcher.getShooterIntakeCommand());
  ...
  //right bumper    trty deleting this /* 
    m_operatorController.leftBumper().whileTrue(m_Intake.getIntakeNoteReverseCommand());
    m_operatorController.leftBumper().whileTrue(m_launcher.getReverseShooterIntakeCommand());
