...
public class PrepareLauncher extends Command {
 // PWMLauncher m_launcher;

   CANLauncher m_launcher;

  /** Creates a new PrepareLaunch. */
  public PrepareLauncher(CANLauncher launcher) {
...
public static Object setPreparelauncher(double d) {
    // TODO Auto-generated method stub
    throw new UnsupportedOperationException("Unimplemented method 'setPreparelauncher'");
}
}
