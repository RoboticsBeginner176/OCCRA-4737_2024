...
import occra.Robot.Command.Auto;
...
// Rodent Turtle Tina waz hear
  ...
  private void configureBindings() {
   ...
   // m_operatorController
    ...
    // left trigger
    //m_operatorController.x().whileTrue(m_Launcher.getAmpShooterCommand());
    ...
    m_operatorController.y().whileTrue(m_Climber.getClimberReverseCommand());
    ...
    //m_operatorController.leftBumper().whileTrue(m_Launcher.getShooterIntakeCommand());
  ...
  //right bumper    trty deleting this /* 
    m_operatorController.rightTrigger().whileTrue(m_Intake.getIntakeNoteReverseCommand());
    //m_operatorController.x().whileTrue(m_Launcher.getReverseShooterIntakeCommand());
  ...
  public Command getAutonomousCommand() {
    ...
    //return Auto.elevatorAuto(m_Elevator);
    return Auto.LEFTtwoBallAuton(m_drivetrain, m_Launcher, m_Intake);
  }
}
