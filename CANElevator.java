...
//import static occra.Robot.Constants.ElevatorConstants;
...
public class CANElevator extends SubsystemBase {
  ...
  /** Creates a new Elevator. */
   public CANElevator() {
    m_elevator = new CANSparkMax(12, MotorType.kBrushless);
    
    m_elevator.setSmartCurrentLimit(80);
